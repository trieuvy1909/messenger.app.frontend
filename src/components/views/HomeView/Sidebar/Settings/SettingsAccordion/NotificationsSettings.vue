...
<template>
  ...
  <Collapse id="notifications-settings-collapse" :collapsed="props.collapsed">
    <SettingsSwitch
      ...
      :value="!!store.user.settings.allowNotifications"
      :handle-toggle-switch="
        (value) => (store.user.settings.allowNotifications = value)
      "
      class="mb-7"
    />
    <SettingsSwitch
      ...
      :value="!!store.user.settings.keepNotifications"
      :handle-toggle-switch="
        (value) => (store.user.settings.keepNotifications = value)
      "
      class="mb-7"
    />
  </Collapse>
