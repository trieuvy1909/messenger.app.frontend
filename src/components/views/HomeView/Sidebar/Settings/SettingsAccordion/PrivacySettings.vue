...
<template>
  ...
  <Collapse id="privacy-settings-collapse" :collapsed="props.collapsed">
    <SettingsSwitch
      ...
      :value="!!store.user.settings.lastSeen"
      :handle-toggle-switch="
        (value: boolean) => (store.user.settings.lastSeen = value)
      "
      class="mb-7"
    />
    <SettingsSwitch
      ...
      :value="!!store.user.settings.readReceipt"
      :handle-toggle-switch="
        (value: boolean) => (store.user.settings.readReceipt = value)
      "
      class="mb-7"
    />
    <SettingsSwitch
      ...
      :value="!!store.user.settings.joiningGroups"
      :handle-toggle-switch="
        (value: boolean) => (store.user.settings.joiningGroups = value)
      "
      class="mb-7"
    />
    <SettingsSwitch
      ...
      :value="!!store.user.settings.privateMessages"
      :handle-toggle-switch="
        (value: boolean) => (store.user.settings.privateMessages = value)
      "
      class="mb-7"
    />
  </Collapse>
